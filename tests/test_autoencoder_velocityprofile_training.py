...
def test_training():
    ...
    """
    config_file = 'test_smad_velprof_autoencoder.yml'
    train_set = 'climbing_C57_forelimb_vp_train.pt'
    test_set = 'climbing_C57_forelimb_vp_test.pt'
    val_set = 'climbing_C57_forelimb_vp_val.pt'
