...
if __name__ == "__main__":
    ...
    #data_path = Path(get_data_dir(args.data_dir))
    ...
    model, training_info, criterion, optimizer, device = train_model_packed(config_file,train_loader, val_loader, noise=0.0)
